...
APP_DIR="$ROOT_DIR/desktop/build/compose/binaries/main/app/audiobookreader"
...
OUTPUT_FILE="${APPIMAGE_OUTPUT_FILE:-$ROOT_DIR/desktop/build/compose/binaries/main/appimage/audiobookreader-$VERSION-x86_64.AppImage}"
...
test -x "$APP_DIR/bin/audiobookreader" || {
...
cp -a "$APP_DIR" "$STAGING_DIR/audiobookreader"
